...
public class Fclick extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // load the photo
        Bitmap b = BitmapFactory.decodeResource(getResources(), R.drawable.face9);
    ...
    private void doLengthyCalc() {
        Thread t = new Thread() {
            ...
            public void run() {
                try {
                    setFace();
                    m.what = Fclick.GUIUPDATE_SETFACE;
                    Fclick.this.mHandler.sendMessage(m);
                } catch (Exception e) {
